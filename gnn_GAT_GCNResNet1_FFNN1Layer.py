        ...
        for heads in [4, 8]:
            for numUnit1 in [32, 64, 128, 256, 512, 1024, 2048]:
                ...
                while numUnit2 >= 16:
                    ...
                    torch.save(model, f'model_gnn_GAT_1GCN_1FFNN_{reps}_{hidden_dim}_{heads}_{numUnit1}_{numUnit2}.pth')
...
with open("model_gnn_GAT_1GCN_1FFNN.json", "w") as json_file:
