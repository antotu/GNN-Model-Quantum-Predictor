            ...
            for numUnit1 in [32, 64, 128, 256, 512, 1024, 2048]:
                ...
                while numUnit2 >= 16:
                    ...
                    while numUnit3 >= 16:
                        ...
                        torch.save(model, f'GAT_2GCN_2FFNN/model_gnn_GAT_2GCN_2FFNN_{reps}_{hidden_dim}_{heads}_{numUnit1}_{numUnit2}_{numUnit3}.pth')
...
with open("model_gnn_GAT_2GCN_2FFNN.json", "w") as json_file:
